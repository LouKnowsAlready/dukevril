...
class AcademiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create academy" do
    assert_difference('Academy.count') do
      post academies_url, params: { academy: { academy_country: @academy.academy_country, academy_instructor: @academy.academy_instructor, academy_name: @academy.academy_name } }
    end
  ...
  test "should update academy" do
    patch academy_url(@academy), params: { academy: { academy_country: @academy.academy_country, academy_instructor: @academy.academy_instructor, academy_name: @academy.academy_name } }
